...
func (app *application) routes() http.Handler {
	...
	router.HandlerFunc(http.MethodGet, "/v1/images/:filename", app.getImagesHandler)
	router.HandlerFunc(http.MethodGet, "/v1/images/:filename/metadata", app.getImagesMetadataHandler)
