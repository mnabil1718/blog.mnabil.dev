...
export default function ToolbarPlugin({
  ...
  return (
    <div
      className="sticky z-[1] top-[140px] flex overflow-x-auto gap-1 items-center p-3 border-b h-30 bg-background/80 saturate-100 backdrop-blur-[10px] toolbar-scroll"
      ref={toolbarRef}
    >
      {/* UNDO & REDO */}
      <Button
